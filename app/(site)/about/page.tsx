  ...
  return (
    <>
      ...
      <div className="font-serif text-[16.5px] leading-[1.85] text-ink">
        <p>你好，我是王腾飞 ｜ Felix。</p>
        <p className="mt-4">
          工作写代码，业余拍照、运动、看书，偶尔折腾些自己的小项目，主打一个「折腾得开心就好」。
        </p>

        {/* 摄影：本站主题，展开写 */}
        <h2 className={sectionLabel}>摄影</h2>
        <p>
          这两年才开始认真拍照。喜欢扫街、拍风景，技术还在入门阶段，但每次拍到喜欢的照片都会开心一整天。这里就是把那些瞬间收起来的地方——按相册归类，配上一点当时的感受，像一本可以翻回去的视觉日记。
        </p>
        <p className="mt-4">
        ...
        {/* 这个站点 */}
        <h2 className={sectionLabel}>这个站点</h2>
        <p>
          Flight Albums 是我的摄影作品展示站
          ——暖纸底色，窗外树影落在纸面上缓缓晃动，居中一行「进入」。
          希望这里安静一点，让照片自己说话。
        </p>
        <p className="mt-4 text-ink-2">
          如果某张照片恰好让你停下看了几秒，那我会很开心。欢迎随时来聊。
        </p>
      </div>
